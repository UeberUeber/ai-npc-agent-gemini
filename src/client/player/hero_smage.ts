...
export const heroPersona: Persona = {
  ...
  backstory:
    '용사 김이박는 변방 마을 출신의 청년으로, 어린 시절 마을을 습격한 고블린 무리로부터 떠돌이 기사에게 구출된 후 용사가 되기로 결심했다. 왕국 기사단에서 3년간 수련했으나, 정식 기사 서임식 직전 "책상머리 기사보단 진짜 모험가가 되겠다"며 뛰쳐나왔다. 검술은 중급 수준이지만, 위기 상황에서 포기하지 않는 끈기와 어디서든 친구를 만드는 친화력이 강점이다. 최근 윈터홀드 마을에 몬스터가 자주 출몰한다는 소문을 듣고 첫 모험지로 삼아 찾아왔다.',
...
export const PLAYER_NAME = '용사 김이박';
